...
Since the Wallet may request one or more Status Assertions, issued by the same Credential Issuer, the credential_pop object MUST adhere to the following specification:
...
The status_assertion object MUST adhere to the following specification:
- `status_assertion`. REQUIRED. By default, it MUST be an array of strings (array[string]).
